  ...
  return (
    <div className="fixed inset-0 z-40">
      ...
      <div
        ...
        aria-label={title}
        tabIndex={-1}
        className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-lg max-h-[85vh] overflow-y-auto p-5 outline-none"
        style={{ background: "var(--color-bg)", borderTop: "2px solid var(--color-text)" }}
      >
